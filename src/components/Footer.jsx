        ...
        <footer>
            <div className="container my-5">
                <div className="row align-items-center">
                    ...
                    <div className="col-4 d-flex align-items-center flex-column p-3">
                    ...
                    <div className="col-4 d-flex align-items-center flex-column p-3">
                        ...
                        <ul className="list-group list-group-flush d-flex justify-content-center align-items-start flex-column">
                            <li className="list-group-item bg-transparent border-0 text-light px-0">
                                <NavLink to='/products' className=" text-decoration-none">Come Acquistare</NavLink>
                            </li>
                            <li className="list-group-item bg-transparent border-0  px-0">
